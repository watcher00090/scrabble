(function() {
    window.onload = function() {
        ...
        $("#optimizebutton").click(function () {
            ...
            for (i = 0; i < textareas.length; i++) {
                ...
                if (textareas[i].value != "") board[row][col].hasLetter =  true;
                debugger;
            }
    ...
    function displayAssigned(board) {
        ...
        for (var i = 0; i < textareas.length; i++) {
            textareas[i].classList.remove("assigned"); // clears the board of displays from prior assignments
            textareas[i].innerHTML = "";

            var row = textareas[i].row;
            var col = textareas[i].col;
            if (board[row][col].assignedLetter != null) {
                textareas[i].classList.add("assigned");
